...
namespace MEF.PROYECTO.Data.Coordinador
{
    public class Cls_Dat_Covid: DataBaseHelper
    {
        ...
        {
            string sp = "FAGPAC.PACK_EXTRANET_COORDINADOR.SP_REEVALUACION_INSERT_COVID";
            try
            {
        ...
        public List<Cls_Ent_Reevaluacion> ListaReevaluacionCovid(Cls_Ent_Reevaluacion entidad)
        {
            ...
            string sp = "FAGPAC.PACK_EXTRANET_COORDINADOR.USP_LISTA_REEVALUACION_COVID";
            try
            {
        ...
        {
            string sp = "FAGPAC.PACK_EXTRANET_COORDINADOR.PRC_UPD_DOCUMENTO_COVID";
            try
            {
        ...
        {
            string sp = "FAGPAC.PACK_EXTRANET_COORDINADOR.PRC_UPD_ESTADO_ENVIO_COVID";
            try
            {
